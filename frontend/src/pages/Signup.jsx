  ...
  return <section className="px-5 xl:px-0">
    <div className="max-w-[1170px] mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        focus:border-b-primaryColor text-[22px] leading-7 text-headingColor placeholder:textColor cursor-pointer"
        required
        />
      ...
      <div className="mb-5">
        <input type="email" 
        placeholder="Enter the email adderss" 
        name="email" 
      ...
      <label htmlFor="customFile" className="absolute top-0 left-0 w-full
       h-full flex items-center px-[0.75rem] py-[0.375rem] text-[15px] leading-6 
       overflow-hidden bg-[#0066ff46] text-headingColor font-semibold rounded-lg
        truncate cursor-pointer ">Upload Photo</label>
      </div>
      </div>
      <div className="mt-7">
